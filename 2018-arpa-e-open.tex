...
\begin{compactitem}
  ...
  \item A pebble bed, fluorite salt-cooled, high temperature
    reactor \cite{andreades_design_2016}
  \item A molten salt, single-fluid, breeder
    reactor\cite{robertson_conceptual_1971}.
\end{compactitem}
Each of these reactor types are computationally difficult for unbiased Monte
Carlo to simulate alone. A method to more effectively transport particles will
aid in future design iterations, allowing for faster design turnaround and lower
computational energy use in the design phase.
